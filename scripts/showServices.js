            ...
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                  ...
                  <div class="botnes-CRUD">
                    <button onclick="editService(${id})" id="btnEditarTarget" class="btn btn-success">EDITAR</button>
                    <button onclick="deleteServiceL(${id})"  class="btn btn-danger">ELIMINAR</button>
                  </div>  
                </div>
            </div>
        `
